...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> addComment(
        ...
        CommentResponse comment = commentService.addComment(postId, request, userId, httpRequest);
    ...
    public ResponseEntity<ApiResponse<Page<CommentResponse>>> getComments(
        ...
        Page<CommentResponse> comments = commentService.getComments(postId, page, size, request);
